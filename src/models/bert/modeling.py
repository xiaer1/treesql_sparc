...
class BertConfig(object):
    ...
    def print_status(self):
        ...
        print( "num_hidden_layer: {}".format(self.num_hidden_layers))
        print( "num_attention_heads: {}".format(self.num_attention_heads))
        print( "hidden_act: {}".format(self.hidden_act))
        print( "intermediate_size: {}".format(self.intermediate_size))
        print( "hidden_dropout_prob: {}".format(self.hidden_dropout_prob))
        print( "attention_probs_dropout_prob: {}".format(self.attention_probs_dropout_prob))
        print( "max_position_embeddings: {}".format(self.max_position_embeddings))
        print( "type_vocab_size: {}".format(self.type_vocab_size))
        print( "initializer_range: {}".format(self.initializer_range))
